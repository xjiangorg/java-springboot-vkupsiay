...
export IMAGE_URL=${IMAGE_URL-nexus-docker-nexus.apps.rosa.rhtap-services.xmdt.p3.openshiftapps.com/quay_xjiang/java-springboot-vkupsiay:$CI_TYPE-$TAG}
...
export GITOPS_REPO_URL=https://github.com/xjiangorg/java-springboot-vkupsiay-gitops
